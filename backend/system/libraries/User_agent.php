...
class CI_User_agent {
	...
	{
		if (defined('ENVIRONMENT') AND is_file(BACK_PATH.'config/'.ENVIRONMENT.'/user_agents.php'))
		{
			include(BACK_PATH.'config/'.ENVIRONMENT.'/user_agents.php');
		}
		elseif (is_file(BACK_PATH.'config/user_agents.php'))
		{
			include(BACK_PATH.'config/user_agents.php');
		}
		else
		{
			return FALSE;
