...
/**
 * Kontroller pada tipe-konten Agenda
 *
 * @package  ContentType\Agenda\Controller
 * @author   Iyan Kushardiansah <iyank4@gmail.com>
 */
class Agenda extends ContentTypeController
{
    public function title()       { return 'Agenda'; }
    public function description() { return "Agenda +ReadCounter"; }
    public function version()     { return '1.0.1'; }
    public function mainModel()   { return 'AgendaModel'; }
    ...
    public function save()
    {
        ...
        $article = $this->kwitang->ctModel('Agenda', 'AgendaModel');
