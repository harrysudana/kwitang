...
/**
 * Kontroller pada tipe-konten Text
 *
 * @package  ContentType\Text\Controller
 * @author   Iyan Kushardiansah <iyank4@gmail.com>
 */
class Text extends ContentTypeController
{
    public function title()       { return 'Teks'; }
    public function description() { return "Tipe Konten Teks"; }
    public function version()     { return '1.0.0'; }
    public function mainModel()   { return 'TextModel'; }
    ...
    public function save()
    {
        ...
        $text = $this->kwitang->ctModel('Text', 'TextModel');
