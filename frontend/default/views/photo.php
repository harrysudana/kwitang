      ...
      foreach ($content['data'] as $value) {
        ...
        if ( ! empty ($value->foto1)) {
          echo '<a class="pull-left" href="'.$_url.'">
                  <img class="media-object" src="'.base_url($value->foto1).'" alt="'.$value->description1.'" height="128">
                </a>';
        }
        if ( ! empty ($value->foto2)) {
          echo '<a class="pull-left" href="'.$_url.'">
                  <img class="media-object" src="'.base_url($value->foto2).'" alt="'.$value->description2.'" height="128">
                </a>';
        }
        if ( ! empty ($value->foto3)) {
          echo '<a class="pull-left" href="'.$_url.'">
                  <img class="media-object" src="'.base_url($value->foto3).'" alt="'.$value->description3.'" height="128">
                </a>';
        }
        if ( ! empty ($value->foto4)) {
          echo '<a class="pull-left" href="'.$_url.'">
                  <img class="media-object" src="'.base_url($value->foto4).'" alt="'.$value->description4.'" height="128">
                </a>';
        }
